\section{Divisione Per Corso di Studi}
...
\thispagestyle{empty} %Inizio Commercio Estero
\newgeometry{top=1cm,bottom=1cm}
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.55]{COMMERCIO_ESTERO-Totale-ist}}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.55]{COMMERCIO_ESTERO-Totale-box}
  \caption{Commercio Estero}
\end{figure}
\restoregeometry
\clearpage

\thispagestyle{empty} %Inizio Economia Aziendale
\newgeometry{top=1cm,bottom=1cm}
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.55]{ECONOMIA_AZIENDALE-Totale-ist}}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.55]{ECONOMIA_AZIENDALE-Totale-box}
  \caption{Economia Aziendale}
\end{figure}
\restoregeometry
\clearpage

\thispagestyle{empty} %Inizio Marketing e gest. Imprese
\newgeometry{top=1cm,bottom=1cm}
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.55]{MARKETING_E_GEST._IMPRESE-Totale-ist}}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.55]{MARKETING_E_GEST._IMPRESE-Totale-box}
  \caption{Marketing e gest. Imprese}
\end{figure}
\restoregeometry
\clearpage

\thispagestyle{empty} %Inizio Economia Gest. Serv. Turistici
\newgeometry{top=1cm,bottom=1cm}
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.55]{ECONOMIA_GEST._SERV._TURISTICI-Totale-ist}}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.55]{ECONOMIA_GEST._SERV._TURISTICI-Totale-box}
  \caption{Economia Gest. Serv. Turistici}
\end{figure}
\restoregeometry
\clearpage
