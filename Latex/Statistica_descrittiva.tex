...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.52]{dati-Italiano-ist}}
  \caption{Italiano}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.52]{dati-Italiano-box}
  \caption{Italiano}
\end{figure}
\restoregeometry
\clearpage
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.50]{dati-Test-ist}}
  \caption{Test}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.50]{dati-Test-box}
  \caption{Test}
\end{figure}
...
\begin{figure}[!h]
  \makebox[\textwidth]{%
  \includegraphics[scale=0.50]{dati-Totale-ist}}
  \caption{Totale}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.50]{dati-Totale-box}
  \caption{Totale}
\end{figure}
